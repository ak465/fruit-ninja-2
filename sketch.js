var sword, swordImage, enemyG, enemyImage, fruit1, fruit2,
     fruit3, fruit4, fruit1Image, fruit2Image, 
fruit3Image, fruit4Image, score,gameOverImage
var PLAY=1;
var END=0
var gameState=PLAY;
...
function enemy(){
  ...
  var
  enemy=createSprite(600,Math.round(random(30,400)) ,10, 10)
...
function fruit1(){
  var
fruit1=createSprite(600,Math.round(random(30,400)),10 ,10)
...
function fruit2(){
  var
fruit2=createSprite(600,Math.round(random(30,400)),10 ,10)
...
function fruit3(){
  var
fruit3=createSprite(600,Math.round(random(30,400)),10 ,10)
...
function fruit4(){
  var
fruit4=createSprite(600,Math.round(random(30,400)),10 ,10)
